<?php
/* @var $this OperadorasActivasController */
/* @var $model OperadorasActivas */
?>
...
<fieldset>
    ...
    <legend>Operadoras Activas</legend>


<?php
$this->widget( 'booster.widgets.TbExtendedGridView' , array (
        'id'=>'operadoras-activas-grid',
...
<script type="text/javascript">
	...
	{
	    $.ajax({
	        url:"<?php echo Yii::app()->createUrl('/operadorasActivas/update'); ?>",
	        type:"POST",    
	        dataType: 'json',  
	        ...
	        error: function()
	        {
	        	alert("Ocurrio un error al cargar actulizar los datos");
	        }
	    });
	}
</script>