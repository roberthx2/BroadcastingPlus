        ...
        'columns'=> array(
        	array(
	            ...
	            'editable' => array(    //editable section
                  	...
                  	'params' => array("model"=>"PalabrasObscenas"),
                  	//'showbuttons' => false,
...
<input type="hidden" id="palabras_eliminar" value="">
...
<?php $this->beginWidget(
    ...
    <div class="modal-header" style="background-color:#d2322d">
		...
		<h4 class="modal-title" style="color:#fff;"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar Palabra(s)</h4>
    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		$('#confirmar').click(function(){
		    $.ajax({ 
                url:"<?php echo Yii::app()->createUrl('palabrasObscenas/deletePalabra'); ?>",
                type:"POST",    
                data:{id:$("#palabras_eliminar").val()},
                ...
                success: function(data)
                {
                	if (data.salida !== 0)
                	{
                		var mensaje = "<center><strong>Palabra(s) eliminado(s) correctamente</center></strong>";
                		$("#palabra-obscena-grid").yiiGridView("update"); 
                	}
                	else
                	{
                		var mensaje = "<center><strong>No se pudo eliminar ninguna palabra, intente nuevamente</center></strong>";
                	}
                ...
                error: function()
                {
                    $("#divModalEliminar").html("<center><strong>Ocurrio un ERROR al intentar eliminar las palabras</center></strong>");
                    $("#modal_footer").hide();
                }
            });
		});
