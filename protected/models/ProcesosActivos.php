...
/**
 * This is the model class for table "procesos_activos".
 *
 ...
 */
class ProcesosActivos extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tmpProcesamientos' => array(self::HAS_MANY, 'TmpProcesamiento', 'id_proceso'),
		);
	}
	 ...
	 * @return ProcesosActivos the static model class
	 */
